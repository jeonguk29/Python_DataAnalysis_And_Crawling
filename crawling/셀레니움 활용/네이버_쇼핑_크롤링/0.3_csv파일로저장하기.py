...
# 파일 생성 
f = open(r"C:\포폴\GIT_PULL\GIT_Python_Data_Analysis_Crawling\crawling\셀레니움 활용\네이버_쇼핑_크롤링\data.csv", "w", encoding="CP949", newline="")
# r 넣어서 로우 문자열로 만듬  그리고 끝에 이름 생성 data.csv 
# 쓰기모드 그리고 인코딩 속성 과 줄 바꿈 없에줌 
